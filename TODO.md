...
## Utilities
- [ ] String parser for object/list format ```{key1:value1, key2:value2}```
- [ ] Case sensor (primarily used by the text renderer)

## Graphics
- [ ] Renderers
    - [ ] Text renderer (use pen, not stamping to control the color)
