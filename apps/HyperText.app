...
def init() {
    ...
    global template_script = license + "//when your app is opened\ndef init() {\n    global window = window() //creates a global window object with the size 240 * 180\n    window.center() //centers the window around 0, 0 coordinates\n}\n\n//is called every frame\ndef frame() {\n    \n}"

    global project_name = ""
    global project_content = ""
    global project_data_file = "project_data.hyp"
    global project_path = ""
    global root_path = "red_os/user/HyperText Documents"
